...
//
// Ported to RikkaLLM:
//   - video/video_processor.h include and related paths removed (video not ported)
//   - Firebase analytics reporting (ReportLlmSetConfigToFirebase) removed
//   - audio (wavform) output support removed
//   - benchmark helpers removed (kept in upstream MnnLlmChat)
//
