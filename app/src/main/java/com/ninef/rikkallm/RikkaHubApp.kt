...
import com.ninef.rikkallm.service.MemoryConsolidationWorker
import com.ninef.rikkallm.data.ai.cron.CronJobWorkScheduler
import java.util.concurrent.TimeUnit
import com.whl.quickjs.android.QuickJSLoader
import com.ninef.rikkallm.di.appModule
import com.ninef.rikkallm.di.dataSourceModule
import com.ninef.rikkallm.di.editorModule
import com.ninef.rikkallm.di.graphModule
import com.ninef.rikkallm.di.pluginModule
import com.ninef.rikkallm.di.mnnLocalModule
import com.ninef.rikkallm.di.repositoryModule
import com.ninef.rikkallm.di.viewModelModule
...
import com.ninef.rikkallm.service.WebServerService
import com.ninef.rikkallm.utils.CrashHandler
import com.ninef.rikkallm.utils.DatabaseUtil
...
class RikkaHubApp : Application() {
    override fun onCreate() {
        ...
        startKoin {
            ...
            workManagerFactory()
            modules(appModule, viewModelModule, dataSourceModule, repositoryModule, mnnLocalModule, editorModule, pluginModule, graphModule)
        }
        ...
        // Cron 无人值守任务周期调度（每 15 分钟唤醒扫描到期任务）
        CronJobWorkScheduler.schedule(this)

        // 图谱随对话演进自动增量同步（生成完成后非破坏性追加节点）
        get<GraphAutoSync>().start(get<AppScope>())
