package com.ninef.rikkallm.ui.pages.extensions.workspace
...
import com.ninef.rikkallm.data.ai.tools.resolveWorkspaceToolApproval
...
import com.ninef.rikkallm.ui.components.ui.ImagePreviewDialog
...
import com.ninef.rikkallm.utils.fileSizeToString
        ...
        topBar = {
            TopAppBar(
                ...
                actions = {
                    ...
                    IconButton(onClick = { navController.navigate(Screen.Ide(id)) }) {
                        Icon(HugeIcons.File02, contentDescription = "IDE")
                    }
                },
