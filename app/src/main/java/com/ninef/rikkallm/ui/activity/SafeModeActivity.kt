package com.ninef.rikkallm.ui.activity
...
import com.ninef.rikkallm.ui.hooks.writeStringPreference
import com.ninef.rikkallm.ui.theme.RikkahubTheme
import com.ninef.rikkallm.RouteActivity
                    ...
                    Column(
                        ...
                        if (stackTrace != null) {
                            ...
                            Card(
                                ...
                                // 逐行虚拟化渲染，可流畅承载任意长度的崩溃日志（避免整体测量导致的卡顿/ANR）
                                val lines = remember(stackTrace) { stackTrace.lineSequence().toList() }
                                LazyColumn(
                                    modifier = Modifier
                                        .fillMaxSize()
                                        .padding(12.dp)
