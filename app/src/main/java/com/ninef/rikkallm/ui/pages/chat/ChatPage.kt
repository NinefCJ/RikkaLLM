...
import com.ninef.rikkallm.service.ChatError
import com.ninef.rikkallm.ui.components.ai.ChatInput
import com.ninef.rikkallm.ui.components.ai.FilesPicker
import com.ninef.rikkallm.ui.components.ai.completion.WorkspaceCompletionProvider
import com.ninef.rikkallm.ui.components.ai.useCropLauncher
import com.ninef.rikkallm.ui.components.ui.permission.PermissionCamera
import com.ninef.rikkallm.ui.components.ui.permission.PermissionManager
import com.ninef.rikkallm.ui.components.ui.permission.rememberPermissionState
...
import com.ninef.rikkallm.ui.hooks.ChatInputState
import com.ninef.rikkallm.ui.hooks.EditStateContent
import com.ninef.rikkallm.ui.hooks.useEditState
import com.ninef.rikkallm.utils.ImageUtils
import com.ninef.rikkallm.ui.pages.chat.components.ChatMode
import com.ninef.rikkallm.ui.pages.chat.components.ChatModeSelector
import com.ninef.rikkallm.ui.pages.ide.IdePane
import com.ninef.rikkallm.utils.base64Decode
import com.ninef.rikkallm.utils.isAllowedFileType
import com.ninef.rikkallm.utils.navigateToChatPage
...
private fun ChatPageContent(
    ...
    // 模式状态按对话隔离：新对话时重置，重新引导选择模式
    var chatMode by rememberSaveable(conversation.id) { mutableStateOf(ChatMode.AGENT) }
    var modeSelected by rememberSaveable(conversation.id) { mutableStateOf(false) }
    val isModeSelection = conversation.messageNodes.isEmpty() && !modeSelected
        ...
        Scaffold(
            topBar = {
                TopBar(
                    ...
                    onOpenGraph = {
                        navController.navigate(Screen.GraphCanvas(conversationId = conversation.id.toString()))
                    }
                )
            },
            bottomBar = {
            ...
            when {
                ...
                chatMode == ChatMode.IDE -> {
                    IdePane(
                        modifier = Modifier
                            .fillMaxSize()
                            .padding(innerPadding),
                        workspaceId = assistant.workspaceId?.toString(),
                        onInsertToChat = { text -> inputState.setMessageText(text) },
                    )
                }
