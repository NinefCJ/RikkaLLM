    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            sections.forEach { section ->
                item(key = "section_${section.workspaceId ?: "unassigned"}") {
                    WorkspaceSectionHeader(section)
                }
...
private fun WorkspaceSectionHeader(
    ...
    Row(
        ...
        Text(
            text = section.workspaceName ?: stringResource(R.string.history_page_unassigned_workspace),
        ...
        Text(
            text = "${section.conversations.size}",
